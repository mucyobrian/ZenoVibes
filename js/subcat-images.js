...
const SUBCAT_IMAGES = {
  // ── clothing ──
  'clothing:Dresses': `${SUBCAT_BASE}Dresses.jpg`,
  'clothing:Tops & Tees': `${SUBCAT_BASE}SUBCTEST.jpg`,
  'clothing:Shirts & Blouses': `${SUBCAT_BASE}Shirts & Blouses.jpg`,
  'clothing:Pants & Jeans': `${SUBCAT_BASE}Pants & Jeans.jpg`,
  'clothing:Shorts': `${SUBCAT_BASE}Shorts.jpg`,
  'clothing:Suits & Blazers': `${SUBCAT_BASE}SUBCTEST.jpg`,
  'clothing:Coats & Jackets': `${SUBCAT_BASE}Coats & Jackets.jpg`,
  'clothing:Hoodies & Sweatshirts': `${SUBCAT_BASE}Hoodies & Sweatshirts.jpg`,
  'clothing:Sweaters': `${SUBCAT_BASE}SUBCTEST.jpg`,
  'clothing:Swimwear': `${SUBCAT_BASE}SUBCTEST.jpg`,
  'clothing:Underwear & Intimates': `${SUBCAT_BASE}Underwear & Intimates.jpg`,
  ...
  'jewelry:Digital Watches': `${SUBCAT_BASE}Digital Watches.jpg`,
  'jewelry:Mechanical Watches': `${SUBCAT_BASE}Mechanical Watches.jpg`,
  'jewelry:Earrings': `${SUBCAT_BASE}SUBCTEST.jpg`,
  'jewelry:Necklaces': `${SUBCAT_BASE}Necklaces.jpg`,
  'jewelry:Rings': `${SUBCAT_BASE}Rings.jpg`,
  ...
  'jewelry:Body Jewelry': `${SUBCAT_BASE}Body Jewelry.jpg`,
